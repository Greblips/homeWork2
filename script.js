...
alert(`Создатель JavaScrip - ${javaScriptCreator}`)
...
alert(`Сумма 10 и 2 равна ${number1+number2}`);
alert(`Разность 10 и 2 равна ${number1-number2}`);
alert(`Произведение 10 на 2 равна ${number1*number2}`);
alert(`Деление 10 на 2 равно ${number1/number2}`);


// Задание 5
// Возведите 
// 2 в 5-ю степень. Результат запишите в переменную 
// result
...
// Задание 9.4
// Создайте переменную info, присвойте ей значение с помощью метода prompt() "Какую информацию хотите узнать о пользователе?".Далее обращайтесь к свойствам объекта 
